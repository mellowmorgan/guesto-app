class GreetingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @greeting.save
        format.html { redirect_to greeting_path(@greeting), notice: "Greeting was successfully created." }
  ...
  def update
    respond_to do |format|
      if @greeting.update(greeting_params)
        format.html { redirect_to greeting_path(@greeting), notice: "Greeting was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to greetings_path, notice: "Greeting was successfully destroyed." }
